...
var JOY_URL_ORG_AT_LIST_URL = joy.getContextPath() + "/collect/list.action";
var ITEM_TEMPLATE = '<li class="join-row"><div class="td td-1"><a href="{linkUrl}" class="title">{name}</a></div><div class="td td-2"></div><div class="td td-3">{collectTime}</div><div class="td td-4"></div></li>';
